<<<<<<<< HEAD:product-service/domain/src/test/java/com/opinai/product/domain/genre/GenreIdTest.java
...
>>>>>>>> feat/product:api-gestao-produto/domain/src/test/java/com/opinai/product/domain/subcategory/SubcategoryIdTest.java
...
public class SubcategoryIdTest extends UnitTest {
    ...
    public void givenAInvalidGenreId_whenCallsNewGenreId_thenShouldReturnNotification() {
        ...
        //when
        SubcategoryId sut = SubcategoryId.from(invalidGenreId);
